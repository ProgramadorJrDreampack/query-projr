...
LEFT JOIN PDN1 T4 ON T2."DocEntry" = T4."BaseEntry" AND T2."LineNum" = T4."LineNum" AND T4."BaseType" = 22   --Linea Entrada de mercancias
LEFT JOIN OPDN T5 ON T4."DocEntry" = T5."DocEntry"
LEFT JOIN PCH1 T6 ON T4."DocEntry" = T6."BaseEntry" AND T4."LineNum" = T6."LineNum"  --Linea Factura de proveedores
LEFT JOIN OPCH T7 ON T6."DocEntry" = T7."DocEntry" -- Factura de proveedores

WHERE 
 --T3."DocNum" = '25002983' AND
T0."CANCELED" = 'N' AND
T0."U_SYP_TIPCOMPRA" = '01' 
AND YEAR(T0."DocDate") >= '2024'
AND T0."DocNum" = '24000298'
UNION ALL
...
SELECT 
    ...
    CASE WHEN T0."DocStatus" = 'C' THEN 'Closed' WHEN T0."DocStatus" = 'O' THEN 'Open' ELSE T0."DocStatus" END AS "Status PO",
...
WHERE 
  ...
  AND NOT EXISTS (SELECT 1 FROM PRQ1 P WHERE T1."DocEntry" = P."TrgetEntry" AND T1."LineNum" = P."LineNum")
  AND YEAR(T0."DocDate") >= '2024'
  AND T0."DocNum" = '24000732'
  --AND T0."DocNum" = '25002983'
 --AND T0."DocNum" = '26000146'